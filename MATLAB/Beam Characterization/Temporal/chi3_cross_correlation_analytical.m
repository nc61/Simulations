function normalized_transmission = chi3_cross_correlation_analytical(delay_fs, delay_shift_fs, pump_refractive_index, pump_group_index, probe_group_index, pump_spot_size_m_HWeM, ...
...
if (pump_group_index == probe_group_index)
    normalized_transmission = -2*alpha_2_m_per_W*pi^(-3/2)*pump_energy_J*sample_thickness_m*1/(pump_spot_size_m_HWeM^2 + probe_spot_size_m_HWeM^2)*1e15*sqrt(1/(pump_pulsewidth_fs_HWeM^2 + probe_pulsewidth_fs_HWeM^2)) ...
